...
Generated 2026-08-30T15:10:06+00:00 · mode **stub** · catalog `data/responses/2026-08-30`

| Metric | Value | Target | Pass |
|---|---|---|---|
| Relevance precision (signal) | 1.0 | 0.85 | yes |
| Q-classification Jaccard | 1.0 | 0.75 | yes |
...
| Latency p95 /api/v1/ask | 0.0031 | 5.0 | yes |
...
- Sparse / gap questions in this catalog: q2_conversion_blockers, q6_off_platform, q8_intent_vs_bookmark, q10_unmet_needs.
...
- Relevant corpus after gate is 13 (target ≥ 400).
